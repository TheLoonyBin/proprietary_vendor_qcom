...
PRODUCT_COPY_FILES := \
    ...
    vendor/qcom/geeb/proprietary/eglsubAndroid.so:system/vendor/lib/egl/eglsubAndroid.so:qcom \
    vendor/qcom/geeb/proprietary/libEGL_adreno.so:system/vendor/lib/egl/libEGL_adreno.so:qcom \
    vendor/qcom/geeb/proprietary/libGLESv1_CM_adreno.so:system/vendor/lib/egl/libGLESv1_CM_adreno.so:qcom \
    vendor/qcom/geeb/proprietary/libGLESv2_adreno.so:system/vendor/lib/egl/libGLESv2_adreno.so:qcom \
    vendor/qcom/geeb/proprietary/libplayback_adreno.so:system/vendor/lib/egl/libplayback_adreno.so:qcom \
    vendor/qcom/geeb/proprietary/libq3dtools_adreno.so:system/vendor/lib/egl/libq3dtools_adreno.so:qcom \
    ...
    vendor/qcom/geeb/proprietary/libC2D2.so:system/vendor/lib/libC2D2.so:qcom \
    vendor/qcom/geeb/proprietary/libc2d30-a3xx.so:system/vendor/lib/libc2d30-a3xx.so:qcom \
    vendor/qcom/geeb/proprietary/libc2d30.so:system/vendor/lib/libc2d30.so:qcom \
    vendor/qcom/geeb/proprietary/libCB.so:system/vendor/lib/libCB.so:qcom \
    ...
    vendor/qcom/geeb/proprietary/libgsl.so:system/vendor/lib/libgsl.so:qcom \
    ...
    vendor/qcom/geeb/proprietary/libllvm-qcom.so:system/vendor/lib/libllvm-qcom.so:qcom \
    vendor/qcom/geeb/proprietary/libbccQTI.so:system/vendor/lib/libbccQTI.so:qcom \
    ...
    vendor/qcom/geeb/proprietary/librs_adreno_sha1.so:system/vendor/lib/librs_adreno_sha1.so:qcom \
    vendor/qcom/geeb/proprietary/librs_adreno.so:system/vendor/lib/librs_adreno.so:qcom \
    vendor/qcom/geeb/proprietary/libRSDriver_adreno.so:system/vendor/lib/libRSDriver_adreno.so:qcom \
    vendor/qcom/geeb/proprietary/libsc-a3xx.so:system/vendor/lib/libsc-a3xx.so:qcom \
